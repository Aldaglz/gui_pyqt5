...
"")
        ...
        self.Lateral_frame.setMaximumSize(QtCore.QSize(0, 16777215))
...
"")
        ...
        self.btn_Bluetooth = QtWidgets.QPushButton(self.Lateral_frame)
        self.btn_Bluetooth.setMinimumSize(QtCore.QSize(0, 40))
        self.btn_Bluetooth.setMaximumSize(QtCore.QSize(16777215, 40))
        font = QtGui.QFont()
        ...
        font.setItalic(False)
        font.setWeight(9)
        self.btn_Bluetooth.setFont(font)
        self.btn_Bluetooth.setStyleSheet("QPushButton{\n"
"border:0px;\n"
"}\n"
"\n"
"QPushButton:hover{\n"
...
"")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../DinamicMenu/icons/bluetooth.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_Bluetooth.setIcon(icon7)
        self.btn_Bluetooth.setIconSize(QtCore.QSize(24, 24))
...
"")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("icons/video.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("icons/video-off.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gb_Docker_2 = QtWidgets.QGroupBox(self.Connection_page)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.gb_Docker_2.setFont(font)
        self.gb_Docker_2.setStyleSheet("background-color: rgb(12, 12, 12);")
        self.gb_Docker_2.setTitle("")
        self.gb_Docker_2.setObjectName("gb_Docker_2")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.gb_Docker_2)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.label_14 = QtWidgets.QLabel(self.gb_Docker_2)
        self.label_14.setMinimumSize(QtCore.QSize(391, 31))
        self.label_14.setMaximumSize(QtCore.QSize(391, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label_14.setFont(font)
        self.label_14.setObjectName("label_14")
        self.gridLayout_10.addWidget(self.label_14, 0, 0, 1, 2)
        self.cb_Devices = QtWidgets.QComboBox(self.gb_Docker_2)
        self.cb_Devices.setMinimumSize(QtCore.QSize(581, 41))
        self.cb_Devices.setMaximumSize(QtCore.QSize(581, 41))
        self.cb_Devices.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.cb_Devices.setObjectName("cb_Devices")
        self.gridLayout_10.addWidget(self.cb_Devices, 1, 0, 1, 2)
        self.label_15 = QtWidgets.QLabel(self.gb_Docker_2)
        self.label_15.setMinimumSize(QtCore.QSize(91, 111))
        self.label_15.setMaximumSize(QtCore.QSize(91, 111))
        self.label_15.setText("")
        self.label_15.setPixmap(QtGui.QPixmap("blutwo.png"))
        self.label_15.setScaledContents(True)
        self.label_15.setObjectName("label_15")
        self.gridLayout_10.addWidget(self.label_15, 2, 0, 1, 1)
        self.lb_VinID = QtWidgets.QLabel(self.gb_Docker_2)
        self.lb_VinID.setMinimumSize(QtCore.QSize(181, 41))
        self.lb_VinID.setMaximumSize(QtCore.QSize(181, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.lb_VinID.setFont(font)
        self.lb_VinID.setStyleSheet("")
        self.lb_VinID.setObjectName("lb_VinID")
        self.gridLayout_10.addWidget(self.lb_VinID, 2, 1, 1, 1)
        self.btn_Pair = QtWidgets.QPushButton(self.gb_Docker_2)
        self.btn_Pair.setMinimumSize(QtCore.QSize(181, 71))
        self.btn_Pair.setMaximumSize(QtCore.QSize(181, 71))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.btn_Pair.setFont(font)
...
"")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("icons/phone.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_Pair.setIcon(icon10)
        self.btn_Pair.setIconSize(QtCore.QSize(32, 32))
        self.btn_Pair.setObjectName("btn_Pair")
        self.gridLayout_10.addWidget(self.btn_Pair, 3, 0, 1, 1)
        self.btn_Unpair = QtWidgets.QPushButton(self.gb_Docker_2)
        self.btn_Unpair.setMinimumSize(QtCore.QSize(181, 71))
        self.btn_Unpair.setMaximumSize(QtCore.QSize(181, 71))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.btn_Unpair.setFont(font)
        self.btn_Unpair.setStyleSheet("\n"
"\n"
"QPushButton{\n"
"background-color: rgb(255, 255,255);\n"
"\n"
...
"")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("icons/phone-off.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_Unpair.setIcon(icon11)
        self.btn_Unpair.setIconSize(QtCore.QSize(32, 32))
        self.btn_Unpair.setObjectName("btn_Unpair")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_14.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt; color:#ffffff;\">Select Bluetooth Device</span></p></body></html>"))
        self.lb_VinID.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt; color:#ffffff;\">No Vinculado</span></p></body></html>"))
        self.btn_Pair.setText(_translate("MainWindow", "Pair Device"))
        self.btn_Unpair.setText(_translate("MainWindow", "Unpair Device"))
